...
execute unless score second timer matches 1.. unless score minute timer matches 1.. unless score hour timer matches 1.. unless score day timer matches 1.. run scoreboard players set second timer 0
